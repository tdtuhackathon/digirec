...
function InfoProductDetail() {
  ...
  return (
    <div style={{ height: "100%", paddingLeft: "32px", flex: "1" }}>
      <div>
        {menuContents.map(
          ({ id, text, viewer, amout, author, descript, price, star }) => (
            <div key={id}>
              <div>
                {/* Title */}
              ...
              <div className="mt-5">
                {/* Description */}
                <div className="w-[90%] text-[#343D47] text-[1rem]">{descript}</div>
              ...
              <div className="flex mr-10 mt-[30px]">
                <div className="w-[200px] mr-10">
                  <button onClick={handleRentNowClick} className="relative w-[200px] bg-[#343D47] text-white p-3.5 rounded-t-md rounded-none">
                    RENT NOW
                    <div className="absolute bottom-0 left-[0.4rem] border border-solid border-white h-0 w-[184px]"></div>
                  </button>
                  <button className="w-[200px] bg-[#343D47] text-white p-3.5 rounded-b-md rounded-none">
                    SCHEDULE RENT
                  </button>
                </div>
                {showRentNotification && <RentNotification />}
                <div className="mt-2.5">
